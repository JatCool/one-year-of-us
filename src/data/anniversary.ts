...
export const milestones = [
  { icon: '✦', title: 'ПОЧАТОК', date: '25 ВЕРЕСНЯ 2025', text: 'Того дня ми сказали «так» назавжди.', image: '/images/wedding.jpg' },
  { icon: '⌂', title: 'НАШ ДІМ', date: 'ОСІНЬ 2025', text: 'Будуємо життя з тисячі маленьких речей.', image: '/images/home.jpg' },
  { icon: '↗', title: 'НОВІ РОЗДІЛИ', date: 'ЗИМА 2026', text: 'Нові місця. Нові враження. Та сама команда.', image: '/images/winter.jpg' },
  { icon: '☻', title: 'ТРОХИ ХАОСУ', date: 'ВЕСНА 2026', text: 'І якось ми впоралися одне з одним. Навіть красиво.', image: '/images/spring.jpg' },
  { icon: '∞', title: 'ОДИН РІК', date: '25 ВЕРЕСНЯ 2026', text: '365 днів потому — я знову обрав би тебе.', image: '/images/anniversary.jpg' }
]
export const places = [
  { place: 'Україна', date: 'ДЕ ПОЧАЛАСЯ НАША ІСТОРІЯ', note: 'Початок усього найважливішого.', image: '/images/ukraine.jpg' },
  { place: 'Греція', date: 'МАЛЕНЬКА ВТЕЧА', note: 'Сонце, море і ми.', image: '/images/greece.jpg' },
  { place: 'Польща', date: 'НАША ЩОДЕННА ПРИГОДА', note: 'Робимо дім домом, день за днем.', image: '/images/poland.jpg' },
  { place: 'Краків', date: 'МІСТО, ЯКЕ МИ ВІДКРИВАЄМО', note: 'Наші улюблені куточки ще чекають.', image: '/images/krakow.jpg' }
]
...
export const months = monthNames.map((month, i) => ({ month, image: `/images/month-${i + 1}.jpg`, caption: captions[i] }))
